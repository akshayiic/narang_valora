import { g as getContext, s as setContext, j as store_set, d as store_get, k as ensure_array_like, e as attr, f as escape_html, u as unsubscribe_stores, b as pop, p as push } from "../../../chunks/index2.js";
...
function _page($$payload, $$props) {
  ...
  store_set(ishighlights, false);
  const floorPlanImages = {
    "Jodi Floor Plan": "https://assets.vestate.io/webtool/narang/valora/brochure/floorPlan/assets/Jodi%20Floor%20Plan.webp",
    "Jodi Unit 1+2 4BHK Jodi": "https://assets.vestate.io/webtool/narang/valora/brochure/floorPlan/assets/Jodi%20Unit%201%2B2%204BHK%20Jodi.webp",
    "Jodi Unit 5+6 5BHK Jodi": "https://assets.vestate.io/webtool/narang/valora/brochure/floorPlan/assets/Jodi%20Unit%205%2B6%205BHK%20Jodi.webp",
    "Refuge Floor Plan 13th & 27th Floor": "https://assets.vestate.io/webtool/narang/valora/brochure/floorPlan/assets/Refuge%20Floor%20Plan%2013th%20%26%2027th%20Floor.webp",
    "Refuge Floor Plan 20th & 34th Floor": "https://assets.vestate.io/webtool/narang/valora/brochure/floorPlan/assets/Refuge%20Floor%20Plan%2020th%20%26%2034th%20Floor.webp",
    "Refuge Floor Plan 41st Floor": "https://assets.vestate.io/webtool/narang/valora/brochure/floorPlan/assets/Refuge%20Floor%20Plan%2041st%20Floor.webp",
    "Refuge Floor Plan 6th Floor": "https://assets.vestate.io/webtool/narang/valora/brochure/floorPlan/assets/Refuge%20Floor%20Plan%206th%20Floor.webp",
    "Typical Floor Plan": "https://assets.vestate.io/webtool/narang/valora/brochure/floorPlan/assets/Typical%20Floor%20Plan.webp",
    "Unit 1": "https://assets.vestate.io/webtool/narang/valora/brochure/floorPlan/assets/Unit%201.webp",
    "Unit 2": "https://assets.vestate.io/webtool/narang/valora/brochure/floorPlan/assets/Unit%202.webp",
    "Unit 3": "https://assets.vestate.io/webtool/narang/valora/brochure/floorPlan/assets/Unit%203.webp",
    "Unit 4": "https://assets.vestate.io/webtool/narang/valora/brochure/floorPlan/assets/Unit%204.webp",
    "Unit 5": "https://assets.vestate.io/webtool/narang/valora/brochure/floorPlan/assets/Unit%205.webp",
    "Unit 6": "https://assets.vestate.io/webtool/narang/valora/brochure/floorPlan/assets/Unit%206.webp",
    "Unit 7": "https://assets.vestate.io/webtool/narang/valora/brochure/floorPlan/assets/Unit%207.webp"
  };
  const floorPlansList = [
    {
      id: "Jodi Floor Plan",
      label: "Jodi Floor Plan"
    },
    {
      id: "Jodi Unit 1+2 4BHK Jodi",
      label: "Jodi Unit 1+2 4BHK"
    },
    {
      id: "Jodi Unit 5+6 5BHK Jodi",
      label: "Jodi Unit 5+6 5BHK"
    },
    {
    ...
    {
      id: "Refuge Floor Plan 41st Floor",
      label: "Refuge 41st Floor"
    },
    {
      id: "Refuge Floor Plan 6th Floor",
      label: "Refuge 6th Floor"
    },
    {
  ...
  if (!store_get($$store_subs ??= {}, "$ishighlights", ishighlights)) {
    ...
    $$payload.out += ` <!--[-->`;
    if (store_get($$store_subs ??= {}, "$isInteriorsMinimized", isInteriorsMinimized)) {
      $$payload.out += `<img id="int-mx"${attr("src", maximizeBtn, false)} alt="maximize">`;
      $$payload.out += "<!--]-->";
    } else {
      $$payload.out += "<!--]!-->";
    }
    $$payload.out += `</button></div> <div${attr("class", !store_get($$store_subs ??= {}, "$isInteriorsMinimized", isInteriorsMinimized) ? "block" : "hidden", false)}><div class="pt-3"><div class="inner-btn-group"><!--[-->`;
    for (let $$index = 0; $$index < each_array.length; $$index++) {
      const floorPlan = each_array[$$index];
      $$payload.out += "<!--[-->";
      $$payload.out += `<button${attr("class", store_get($$store_subs ??= {}, "$hotspotName", hotspotName) == floorPlan.id ? "active inner-modal-btn " : "inner-modal-btn ", false)}${attr("id", floorPlan.id + "-fp", false)}>${escape_html(floorPlan.label)}</button>`;
      $$payload.out += "<!--]-->";
    }
    $$payload.out += "<!--]-->";
  ...
  $$payload.out += ` <div id="floor-plans-image-container" class="floor-plans-image-wrapper svelte-1m33qb8"><!--[-->`;
  if (store_get($$store_subs ??= {}, "$currentImage", currentImage)) {
    $$payload.out += `<img${attr("src", store_get($$store_subs ??= {}, "$currentImage", currentImage), false)} alt="Floor Plan" class="floor-plans-static-image svelte-1m33qb8">`;
    $$payload.out += "<!--]-->";
  } else {
    $$payload.out += `<img${attr("src", floorPlanImages[floorPlansList[0].id], false)} alt="Floor Plan" class="floor-plans-static-image svelte-1m33qb8">`;
    $$payload.out += "<!--]!-->";
  }
  $$payload.out += `</div>`;
  if ($$store_subs)
