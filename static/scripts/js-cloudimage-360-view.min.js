...
(() => {
	var t = {
			...
			1223: (t, e, n) => {
				...
				var i = n(5112),
					...
					a = i('unscopables'),
					s = Array.prototype;
				void 0 === s[a] && r(s, a, { configurable: !0, value: o(null) }),
					(t.exports = function (t) {
						s[a][t] = !0;
					});
			},
						...
						return function (p, m, v, g) {
							for (
								var y,
									...
									E = 0,
									S = g || c,
									k = e ? S(p, O) : n || h ? S(p, 0) : void 0;
								O > E;
								E++
							)
								if ((f || E in x) && ((b = I((y = x[E]), E, w)), t))
									if (e) k[E] = b;
									else if (b)
										switch (t) {
											case 3:
				...
				function o() {
					...
					function f(t, e, n, i) {
						var o = e && e.prototype instanceof w ? e : w,
							...
							a = new Y(i || []);
						return s(r, '_invoke', { value: L(t, n, a) }), r;
					}
					function p(t, e, n) {
						try {
					...
					var E = Object.getPrototypeOf,
						S = E && E(E(T([])));
					S && S !== r && a.call(S, u) && (O = S);
					var k = (I.prototype = w.prototype = Object.create(O));
					function C(t) {
						...
						return function (r, a) {
							...
							for (i.method = r, i.arg = a; ; ) {
								...
								if ('next' === i.method) i.sent = i._sent = i.arg;
									...
									if (o === m) throw ((o = y), i.arg);
									i.dispatchException(i.arg);
								} else 'return' === i.method && i.abrupt('return', i.arg);
								o = g;
								var u = p(t, n, i);
								if ('normal' === u.type) {
									if (((o = i.done ? y : v), u.arg === b)) continue;
									return { value: u.arg, done: i.done };
								}
								'throw' === u.type && ((o = y), (i.method = 'throw'), (i.arg = u.arg));
							}
						};
					}
					function A(t, n) {
						...
						if (o === e)
							return (
								...
								('throw' === i &&
									t.iterator.return &&
									((n.method = 'return'), (n.arg = e), A(t, n), 'throw' === n.method)) ||
									('return' !== i &&
										((n.method = 'throw'),
					...
					return (
						(x.prototype = I),
						s(k, 'constructor', { value: I, configurable: !0 }),
						s(I, 'constructor', { value: x, configurable: !0 }),
						(x.displayName = h(I, d, 'GeneratorFunction')),
						...
						(n.mark = function (t) {
							return (
								Object.setPrototypeOf
									...
									: ((t.__proto__ = I), h(t, d, 'GeneratorFunction')),
						...
						(Y.prototype = {
							...
							abrupt: function (t, e) {
								...
								return (
									(r.type = t),
									(r.arg = e),
									o ? ((this.method = 'next'), (this.next = o.finallyLoc), b) : this.complete(r)
								);
							},
							...
							finish: function (t) {
								for (var e = this.tryEntries.length - 1; e >= 0; --e) {
									...
									if (n.finallyLoc === t) return this.complete(n.completion, n.afterLoc), D(n), b;
								}
							},
							catch: function (t) {
								for (var e = this.tryEntries.length - 1; e >= 0; --e) {
	...
	(n.n = (t) => {
		...
		(() => {
				...
				R = function (t, e) {
					...
					if (d) {
						var m = r.offsetWidth,
							...
							y =
								((n = (
									(o = m) <= 25 ? '25' : o <= 50 ? '50' : (100 * Math.ceil(o / 100)).toString()
								)
									.toString()
									.split('x')),
								(i = []),
				...
				et = function (t, e, n, i) {
					...
					return (
						r > a ? (c = s / r) : (s = c * r),
						{
							...
							height: c,
							offsetX:
								(t - s) * (arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : 0.5),
							offsetY:
								(e - c) * (arguments.length > 6 && void 0 !== arguments[6] ? arguments[6] : 0.5)
						}
					);
				},
				nt = function (t, e, n) {
			...
			function Lt(t) {
				return St(jt(t)).left + kt(t).scrollLeft;
			}
			function At(t) {
						...
						(('body' !== Ct(e) || Pt(s)) &&
							(u =
								(i = e) !== vt(i) && yt(i)
									...
									: kt(i)),
						yt(e)
							? (((l = St(e, !0)).x += e.clientLeft), (l.y += e.clientTop))
							: s && (l.x = Lt(s))),
					{
			...
			function le(t) {
				...
				if (u) {
					...
					I === vt(n) &&
						...
						(o !== _t && ((o !== Nt && o !== Vt) || r !== Ut)) ||
							((b = Bt),
							(f -= (d && I === x && x.visualViewport ? x.visualViewport.width : I[E]) - i.width),
							(f *= c ? 1 : -1));
				}
				var S,
					k = Object.assign({ position: s }, u && ue),
					C =
						!0 === l
							? (function (t, e) {
									var n = t.x,
						...
						if (I) {
							if (r) {
								var L,
									...
									_ = V[P],
									W = Se(0, O[D], N[D]),
									H = b ? O[D] / 2 - X - W - B - k.mainAxis : M - W - B - k.mainAxis,
									q = b ? -O[D] / 2 + X + W + _ + k.mainAxis : F + W + _ + k.mainAxis,
									U = e.elements.arrow && zt(e.elements.arrow),
									Z = U ? ('y' === w ? U.clientTop || 0 : U.clientLeft || 0) : 0,
									G = null != (L = null == C ? void 0 : C[w]) ? L : 0,
									J = Y + q - G,
									$ = Se(f ? xt(T, Y + H - G - Z) : T, Y, f ? wt(R, J) : R);
								(I[w] = $), (j[w] = $ - Y);
							}
							if (s) {
								var K,
									...
									st = rt ? it : et - O[nt] - E[nt] - at + k.altAxis,
									ct = rt ? et + O[nt] + E[nt] - at - k.altAxis : ot,
									ut =
										f && rt
											? (function (t, e, n) {
													var i = Se(t, e, n);
										...
										if (null != n) {
											...
											try {
												if (((r = (n = n.call(t)).next), 0 === e)) {
													...
													for (
														;
														!(c = (i = r.call(n)).done) && (s.push(i.value), s.length !== e);
														c = !0
													);
											} catch (t) {
												(u = !0), (o = t);
							...
							o = (function (e, n, i) {
								...
								if (
									...
									try {
										...
										console.error(
											"Cloudimage-360: Element with anchorId '".concat(d, "' not exist in the DOM")
										);
									}
								if (s) {
									var y = (function () {
						...
						},
						{
							...
							value: function (t) {
								...
								this.spinReverse ? this.moveActiveIndexDown(e) : this.moveActiveIndexUp(e),
									...
									(this.activeImageY = 1),
									this.update(),
									window.Events360Service && window.Events360Service.next('moved');
							}
						},
						{
							key: 'moveLeft',
										...
										},
										{
											onLeftStart: function (e) {
												e.stopPropagation(),
													t.onSpin(),
													t.left(),
													(t.loopTimeoutId = window.setInterval(t.left.bind(t), t.autoplaySpeed));
											},
											onRightStart: function (e) {
												e.stopPropagation(),
													t.onSpin(),
													t.right(),
													(t.loopTimeoutId = window.setInterval(t.right.bind(t), t.autoplaySpeed));
											},
											onTopStart: function (e) {
												e.stopPropagation(),
													t.onSpin(),
													t.top(),
													(t.loopTimeoutId = window.setInterval(t.top.bind(t), t.autoplaySpeed));
											},
											onBottomStart: function (e) {
												e.stopPropagation(),
													t.onSpin(),
													t.bottom(),
													(t.loopTimeoutId = window.setInterval(t.bottom.bind(t), t.autoplaySpeed));
											},
											onEventEnd: function () {
			...
			(window.CI360 = window.CI360 || {}),
				...
				(window.CI360.getActiveIndexByID = We),
				(window.CI360.update = Ue),
				...
				(window.CI360.left = He),
				(window.CI360.right = qe),
				(window.CI360.setActiveIndex = function (t, e) {
					var n = We(t);
					if (n !== e) {
						for (; n < e; ) qe(t), n++;
						for (; n > e; ) He(t), n--;
