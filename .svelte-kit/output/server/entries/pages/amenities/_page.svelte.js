...
function _page($$payload, $$props) {
  ...
  const amenityImages = {
    "Badminton_Piclkleball court": "https://assets.vestate.io/webtool/narang/valora/brochure/amenities/Badminton_Piclkleball%20court.webp",
    "Banquet 300 01": "https://assets.vestate.io/webtool/narang/valora/brochure/amenities/Banquet%20300%2001.webp",
    "Bussines Center": "https://assets.vestate.io/webtool/narang/valora/brochure/amenities/Bussines%20Center.webp",
    "Gym 300 01": "https://assets.vestate.io/webtool/narang/valora/brochure/amenities/Gym%20300%2001.webp",
    "Indoor Games 300 01": "https://assets.vestate.io/webtool/narang/valora/brochure/amenities/Indoor%20Games%20300%2001.webp",
    "Kids Creche": "https://assets.vestate.io/webtool/narang/valora/brochure/amenities/Kids%20Creche.webp",
    "Lobby 300 01": "https://assets.vestate.io/webtool/narang/valora/brochure/amenities/Lobby%20300%2001.webp",
    "Lounge 300 01": "https://assets.vestate.io/webtool/narang/valora/brochure/amenities/Lounge%20300%2001.webp",
    "Lounge 300 02": "https://assets.vestate.io/webtool/narang/valora/brochure/amenities/Lounge%20300%2002.webp",
    "Yoga 300 01": "https://assets.vestate.io/webtool/narang/valora/brochure/amenities/Yoga%20300%2001.webp"
  };
  const amenitiesList = [
    {
      id: "Badminton_Piclkleball court",
      label: "Badminton/Pickleball Court"
    },
  ...
  if (!store_get($$store_subs ??= {}, "$ishighlights", ishighlights)) {
    ...
    $$payload.out += ` <!--[-->`;
    if (store_get($$store_subs ??= {}, "$isAmenitiesMinimized", isAmenitiesMinimized)) {
      $$payload.out += `<img id="ams-mx"${attr("src", maximizeBtn, false)} alt="maximize">`;
      $$payload.out += "<!--]-->";
    } else {
      $$payload.out += "<!--]!-->";
    }
    $$payload.out += `</button></div> <div${attr("class", !store_get($$store_subs ??= {}, "$isAmenitiesMinimized", isAmenitiesMinimized) ? "block" : "hidden", false)}><div class="pt-3"><div class="inner-btn-group"><!--[-->`;
    for (let $$index = 0; $$index < each_array.length; $$index++) {
      const amenity = each_array[$$index];
      $$payload.out += "<!--[-->";
      $$payload.out += `<button${attr("class", store_get($$store_subs ??= {}, "$hotspotName", hotspotName) == amenity.id ? "active inner-modal-btn " : "inner-modal-btn ", false)}${attr("id", amenity.id + "-am", false)}>${escape_html(amenity.label)}</button>`;
      $$payload.out += "<!--]-->";
    }
    $$payload.out += "<!--]-->";
  ...
  $$payload.out += ` <div id="amenities-image-container" class="amenities-image-wrapper svelte-qvckv0"><!--[-->`;
  if (store_get($$store_subs ??= {}, "$currentImage", currentImage)) {
    $$payload.out += `<img${attr("src", store_get($$store_subs ??= {}, "$currentImage", currentImage), false)} alt="Amenity" class="amenities-static-image svelte-qvckv0">`;
    $$payload.out += "<!--]-->";
  } else {
    $$payload.out += `<img${attr("src", amenityImages[amenitiesList[0].id], false)} alt="Amenity" class="amenities-static-image svelte-qvckv0">`;
    $$payload.out += "<!--]!-->";
  }
  $$payload.out += `</div>`;
  if ($$store_subs)
