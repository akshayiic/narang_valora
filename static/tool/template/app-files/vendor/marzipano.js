			...
			8: [
				function (t, e, i) {
					...
					function u() {
						...
						return (
							f.ARRAY_TYPE != Float32Array && ((t[0] = 0), (t[1] = 0), (t[2] = 0)), (t[3] = 1), t
						);
					}
					function l(t, e, i) {
						i *= 0.5;
			...
			11: [
				function (t, e, i) {
					...
					Object.defineProperty(i, '__esModule', { value: !0 }),
						...
						(i.scaleAndAdd = function (t, e, i, r) {
							return (
								(t[0] = e[0] + i[0] * r), (t[1] = e[1] + i[1] * r), (t[2] = e[2] + i[2] * r), t
							);
						}),
						(i.distance = c),
						(i.squaredDistance = p),
			...
			12: [
				function (t, e, i) {
					...
					function r() {
						...
						return (
							u.ARRAY_TYPE != Float32Array && ((t[0] = 0), (t[1] = 0), (t[2] = 0), (t[3] = 0)), t
						);
					}
					function n(t, e, i) {
						return (
			...
			13: [
				function (t, Wt, e) {
					!(function (t, a, u) {
						...
						function Nt(t, e) {
							return (
								((e = e || {}).recognizers = _(e.recognizers, Nt.defaults.preset)), new Ft(t, e)
							);
						}
						function Ft(t, e) {
							(e = e || {}),
					...
					e.exports = {
						...
						setViewport: function (t, e, i, r) {
							if (0 === i.x && 1 === i.width && 0 === i.y && 1 === i.height)
								return (
									t.viewport(0, 0, t.drawingBufferWidth, t.drawingBufferHeight), void d.identity(r)
								);
							var n = i.x,
								o = p(n, 0, 1),
								s = o - n,
